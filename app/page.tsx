    ...
    <div className="h-full w-full bg-[url('/images/bg-soon.jpeg')] bg-center bg-cover flex flex-col justify-center items-center space-y-10">
      <div className="flex justify-center items-center flex-col gap-y-4 text-center">
        <div className="space-y-2">
          <span className="font-bold text-lg md:text-xl tracking-[0.6rem] md:tracking-[1rem]">
            BIG THINGS ARE
          </span>
          <p className="font-extralight text-3xl md:text-5xl tracking-[1.9rem] md:tracking-[2.2rem] pl-5">
            COMING
          </p>
        </div>
        <div className="-ml-4 md:ml-0">
          <h1 className="text-[90px] md:text-[160px] font-bold !leading-0">
            SOON
          </h1>
      ...
      <div className="flex flex-col justify-center items-center gap-y-2">
        ...
        <p className="font-bold text-[20px]">TECHPUNDITS</p>
      </div>
    </div>
  );
}
